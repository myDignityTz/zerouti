...
@section('content')
    <section class="lg:px-16 mx-auto px-6">
        <header class="lg:mb-12 lg:mt-12 mb-6 mt-6">
            <h1 class="text-teal-500 lg:text-2xl text-xl font-bold text-gradient">Symptoms:</h1>
        </header>
    </section>
    ...
    <section class="flex lg:flex-row flex-col">
        <div class="flex lg:w-1/2 w-full lg:px-16 px-6 lg:py-24 py-12 bg-teal-100 border-r border-teal-200">
            ...
            <div class="w-4/5">
                <h3 class="lg:text-xl text-lg font-bold text-teal-800 mb-4">The most common symptoms occur in women.</h3>
        ...
        <div class="flex lg:w-1/2 w-full lg:px-16 px-6 lg:py-24 py-12 bg-teal-100">
            ...
            <div class="w-4/5">
                <h3 class="lg:text-xl text-lg font-bold text-teal-800 mb-4">Most common symptoms occur in men.</h3>
                <div class="text-lg text-gray-900">
    ...
    <section class="lg:py-24 py-12">
        <div class="lg:px-16 px-6">
            <header class="mb-12">
                <h2 class="mb-4 font-semibold lg:text-2xl text-lg text-teal-700">TYPES OF UTIs</h2>
                        ...
                        <td class="py-6 px-4">
                            <ul>
                                <li class="flex items-center">
                                    ...
                                    <span class="lg:ml-2">Have pain while urinating</span>
                                </li>
                            </ul>
                        </td>
                    </tr>
                        ...
                        <td class="py-6 px-4">
                            <ul>
                                <li class="flex items-center mb-2 lg:border-b-0 border-b pb-4">
                                    ...
                                    <span class="lg:ml-2">Pressure in the diaphragm</span>
                                </li>
                                <li class="flex items-center mb-2 lg:border-b-0 border-b pb-4">
                                    <div class="flex-shrink-0 hidden lg:block">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 text-teal-500 fill-current">
                                    ...
                                    <span class="lg:ml-2">Lower abdominal pain</span>
                                </li>
                                <li class="flex items-center mb-2 lg:border-b-0 border-b pb-4">
                                    <div class="flex-shrink-0 hidden lg:block">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 text-teal-500 fill-current">
                                    ...
                                    <span class="lg:ml-2">Frequent urination, and pain during urination</span>
                                </li>
                                <li class="flex items-center mb-2 lg:border-b-0 pb-4">
                                    <div class="flex-shrink-0 hidden lg:block">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 text-teal-500 fill-current">
                                            <path fill="none" d="M0 0h24v24H0z"/><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-.997-4L6.76 11.757l1.414-1.414 2.829 2.829 5.656-5.657 1.415 1.414L11.003 16z"/>
                                        </svg>
                                    </div>
                                    <span class="lg:ml-2">Urine having blood</span>
                                </li>
                            </ul>
                        </td>
                    </tr>
                        ...
                        <td class="py-6 px-4">
                            <ul>
                                <li class="flex items-center mb-2 lg:border-b-0 border-b pb-4">
                                    ...
                                    <span class="lg:ml-2">Having upper-back pain in the kidney</span>
                                </li>
                                <li class="flex items-center mb-2 lg:border-b-0 border-b pb-4">
                                    <div class="flex-shrink-0 hidden lg:block">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 text-teal-500 fill-current">
                                    ...
                                    <span class="lg:ml-2">Have a high fever</span>
                                </li>
                                <li class="flex items-center mb-2 lg:border-b-0 border-b pb-4">
                                    <div class="flex-shrink-0 hidden lg:block">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 text-teal-500 fill-current">
                                    ...
                                    <span class="lg:ml-2">Have a shaking situation</span>
                                </li>
                                <li class="flex items-center mb-2 lg:border-b-0 border-b pb-4">
                                    <div class="flex-shrink-0 hidden lg:block">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 text-teal-500 fill-current">
                                    ...
                                    <span class="lg:ml-2">Have nausea</span>
                                </li>
                                <li class="flex items-center mb-2 lg:border-b-0 pb-4">
                                    <div class="flex-shrink-0 hidden lg:block">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 text-teal-500 fill-current">
                                    ...
                                    <span class="lg:ml-2">Vomiting</span>
                                </li>
                            </ul>
                        </td>
                    </tr>
